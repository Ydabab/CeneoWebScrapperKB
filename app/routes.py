    ...
    if request.method=="POST":
        ...
        if response.status_code == requests.codes['ok']:
            ...
            if opinions_count:
                ...
                with open(f"app/opinions/{product_id}.json", "w", encoding="UTF-8") as jf: #jf = json_file
                ...
                with open(f"app/products/{product_id}.json", "w", encoding="UTF-8") as jf: #jf = json_file
